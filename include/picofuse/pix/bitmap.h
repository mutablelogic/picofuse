 ...
 * @param color The color to write - for a format with no alpha channel,
 * @p color's own alpha is ignored.
 *
 ...
 * @param color The color to fill with - for a format with no alpha
 * channel, @p color's own alpha is ignored.
 *
