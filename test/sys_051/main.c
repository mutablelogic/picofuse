...
int main(void) {
...

  {
    ...
    sys_scanner_t it = sys_scanner_init(s, sys_scanner_dquote);
...

  {
    ...
    sys_scanner_t it =
        sys_scanner_init(s, sys_scanner_dquote | sys_scanner_nospace);
    expect_token(&it, "\"a\"", 3, 3, sys_scanner_string);
...

  {
    sys_iostream_t *s = sys_string_read("\\n \"a\\tb\"");
    sys_scanner_t it =
        sys_scanner_init(s, sys_scanner_dquote | sys_scanner_escapes);
...

  {
    ...
    sys_scanner_t it =
        sys_scanner_init(s, sys_scanner_squote | sys_scanner_dquote);
