...
// Verified against two independent, complete Adafruit reference drivers
// (Adafruit_STMPE610 for Arduino, and Adafruit_CircuitPython_STMPE610) -
// both use these exact values, byte for byte. SAMPLE_TIME=110 (124 ADC
// clocks), MOD_12B=0 (10-bit), REF_SEL=0 (internal reference).
#define STMPE610_REG_ADC_CTRL1 0x20u
#define STMPE610_ADC_CTRL1_VALUE 0x60u
...
// Also matches both reference drivers exactly: 4 samples, 1 ms touch
// detect delay, 5 ms settling time.
#define STMPE610_REG_TSC_CFG 0x41u
#define STMPE610_TSC_CFG_4SAMPLE 0x80u
